...
| `02_build_zenodo_package.R`                           | Copies the five dataset CSVs and writes a compact file guide plus the versioned data dictionary for Zenodo.                                                                                                                                                         | `exports/zenodo/`                                                           |
