...
This folder contains local, regenerable exports and is excluded from Git except for this README. Build them with [`scripts/exports/`](../scripts/exports/README.md).

| Folder | Contents |
| --- | --- |
| `website/` | JSON and other files consumed by the separate Ngulia website. |
